import { ActiveSchema, CommandoClient, CommandoGuild } from 'pixoll-commando';
...
async function handlePunishment(doc: ActiveSchema, client: CommandoClient<true>, guild: CommandoGuild): Promise<void> {
    const { users } = client;
