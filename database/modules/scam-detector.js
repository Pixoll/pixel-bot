...
const fakeSitesNames = [
    ...
    'discordnitro', 'steamcommunityx', 'discord-nitro', 'steamcommuniuty', 'discrod-gifte', 'discocrd', 'discorid',
    'steam-dlscord', 'steam-discord', 'discord-nltro', 'dlscordapp', 'discrod', 'discrodsteam', 'discordc', 'discocrd-gift',
    'disccord', 'discord-app'
]
...
const antiScamRegex = new RegExp(
    ...
    `(?:${fakeSitesNames.join('|')})\\.` + // site name
    `(?:${urlSuffixes.join('|')}))/?`, // url suffix
    'mi'
)

const officialSitesRegex = new RegExp(
    '^discordapp\\.com|discordapp\\.net|discord\\.com|discord\\.new|discord\\.gift|discord\\.gifts|discord\\.media|' +
    'discord\\.gg|discord\\.co|discord\\.app|dis\\.gd|cdn\\.discordapp\\.com$',
    'i'
)
